...
export function parseExcelDate(val: unknown): Date | undefined {
...
export function getEventStatus(event: ICalendarEvent): IEventStatus {
  if (!event.plannedDate || event.actualDate !== undefined) {
...
export function filterUpcoming(
  ...
  return events.filter((e) => {
    if (e.actualDate !== undefined) return false; // already completed
